...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ex_type", help="individualized or subpopulation", type=str, default="individualized"
    )
    ...
    g = sns.lineplot(data=scoress_subset, x="gamma", y="h_post", hue="scm", n_boot=1000)
    g.axes.axline((0.75, 0.75), (0.95, 0.95), linestyle="--", color="gray")
    plt.show()

    g = sns.lineplot(data=scoress_subset, x="gamma", y="acc_post", hue="scm", n_boot=1000)
    g.axes.axline((0.75, 0.75), (0.95, 0.95), linestyle="--", color="gray")
    plt.show()
